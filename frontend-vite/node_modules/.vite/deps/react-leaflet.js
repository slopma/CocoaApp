...
function MapContainerComponent({ bounds, boundsOptions, center, children, className, id, placeholder, style, whenReady, zoom, ...options }, forwardedRef) {
  const [props] = (0, import_react2.useState)({
    className,
    id,
    style
  });
  const [context, setContext] = (0, import_react2.useState)(null);
  const mapInstanceRef = (0, import_react2.useRef)(void 0);
  (0, import_react2.useImperativeHandle)(forwardedRef, () => context?.map ?? null, [
    context
  ]);
  const mapRef = (0, import_react2.useCallback)((node) => {
  ...
  const contents = context ? import_react2.default.createElement(LeafletContext, {
    value: context
...
var MapContainer = (0, import_react2.forwardRef)(MapContainerComponent);
...
function PaneComponent(props, forwardedRef) {
  const [paneName] = (0, import_react3.useState)(props.name);
  const [paneElement, setPaneElement] = (0, import_react3.useState)(null);
  (0, import_react3.useImperativeHandle)(forwardedRef, () => paneElement, [
    paneElement
  ]);
  const context = useLeafletContext();
  const newContext = (0, import_react3.useMemo)(() => ({
    ...context,
    pane: paneName
  }), [
    context
  ...
  return props.children != null && paneElement != null ? (0, import_react_dom.createPortal)(import_react3.default.createElement(LeafletContext, {
    value: newContext
  }, props.children), paneElement) : null;
}
var Pane = (0, import_react3.forwardRef)(PaneComponent);
...
var Popup = createOverlayComponent(function createPopup(props, context) {
  ...
  (0, import_react4.useEffect)(function addPopup() {
...
function SVGOverlayComponent({ children, ...options }, forwardedRef) {
  ...
  (0, import_react5.useImperativeHandle)(forwardedRef, () => instance);
  return container == null || children == null ? null : (0, import_react_dom2.createPortal)(children, container);
}
var SVGOverlay = (0, import_react5.forwardRef)(SVGOverlayComponent);
...
var Tooltip = createOverlayComponent(function createTooltip(props, context) {
  ...
  (0, import_react6.useEffect)(function addTooltip() {
